...
Args:
  ...
  - tracking_specs (array, optional): Tracking specifications for conversion tracking. Each spec is an object with action.type and pixel ID. Example: [{"action.type": ["offsite_conversion"], "fb_pixel": ["1234567890782"]}]
